...
function init() {
    ...
    addLight(new THREE.DirectionalLight(0xFFFFFF, 0.8, 500), -17.844, 1.107, 1.456);
    addLight(new THREE.DirectionalLight(0xFFFFFF, 0.8, 500), 0.003, 10, 7.500);
    addLight(new THREE.DirectionalLight(0xFFFFFF, 0.8, 500), 5, 10, -10.824);
    addLight(new THREE.DirectionalLight(0xFFFFFF, 0.8, 500), 17.959, 1.201, 1.061);
    addLight(new THREE.DirectionalLight(0xFFFFFF, 0.8, 500), -0.187, -7.189, -0.305);
    addLight(new THREE.DirectionalLight(0xFFFFFF, 0.4, 500), -0.209, -2.119, 8.311);
